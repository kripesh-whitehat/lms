...
class WeeklySpendChart extends Component {
  render() {
    const theme = [
      '#058DC7',
      '#800080',
    ...
    // const chartConfig = getChartData(xAxis);

    return (
      <Chart
        config={getChartData(
          this.props.reports[this.props.id].weekly_spend_hash,
        )}
        modules={[]}
        theme={theme}
        {...this.props}
...
export default connect(mapStateToProps)(WeeklySpendChart)
